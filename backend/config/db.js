...
// Bu satır, .env dosyasını yükleyerek içindeki değişkenleri process.env nesnesine ekler.
...
// dotenv kütüphanesinin config() fonksiyonu, .env dosyasını okur, içindeki değişkenleri ayrıştırır ve process.env nesnesine ekler.
// Böylece uygulama içinde, environment değişkenlere process.env.VARIABLE_NAME şeklinde erişilebilir.
dotenv.config();
